...
public WebDriver driver;
	...
	@Test(description = "This test is to login",  priority = 15)
	public void verifyLogin(@Optional("sampletest@test.com")String usernmae, String password) {
	...
	@Test(description = "This test is to logout", priority = 30)
	...
	@Test(description = "This test is to tidy up the driver", dependsOnMethods = {"setUp"}, priority = 50)
