...
public WebDriver driver;
	...
	@Test(description = "This test is to logout", priority = 30, enabled = false)
	...
	@Test(description = "This test is to tidy up the driver", dependsOnMethods = {"setUp"}, priority = 50, enabled = false)
